...
from dsrg.wicked_contractions.ricmrccsd1_contractions import *
...
def update_t(T, X, ref, denom, reg_denom, T_pert):
    ...
    hc = ref.orbspace['hole_core_alpha']
    ...
    # Reset the v|c and vv|cc blocks to their perturbative estimates
    T['a'][pv, hc] = T_pert['a'][pv, hc]
    T['b'][pV, hC] = T_pert['b'][pV, hC]
    T['aa'][pv, pv, hc, hc] = T_pert['aa'][pv, pv, hc, hc]
    T['ab'][pv, pV, hc, hC] = T_pert['ab'][pv, pV, hc, hC]
    T['bb'][pV, pV, hC, hC] = T_pert['bb'][pV, pV, hC, hC]
