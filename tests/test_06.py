...
def test_mrdsrg_ldsrg2_1():
    ...
    assert np.isclose(driver.correlation_energy, -0.082048938614610, rtol=RTOL, atol=ATOL)
    assert np.isclose(driver.total_energy, -109.097992893831830, rtol=RTOL, atol=ATOL)
