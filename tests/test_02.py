...
def test_mrdsrg_ldsrg2_n2():
    ...
    #
    assert np.isclose(driver.reference_energy, -109.09022707116964, rtol=RTOL, atol=ATOL)
    assert np.isclose(driver.correlation_energy, -0.18563555265997586, rtol=RTOL, atol=ATOL)
    assert np.isclose(driver.total_energy, -109.27586262382961, rtol=RTOL, atol=ATOL)
