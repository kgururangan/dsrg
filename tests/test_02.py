...
def test_mrdsrg_ldsrg2_n2():
    ...
    #print(driver.ref.F['a'][driver.ref.orbspace['virt_alpha'], driver.ref.orbspace['active_alpha']])
    ...
    #
    assert np.isclose(driver.ref.e_cas, -109.09022707116964, rtol=RTOL, atol=ATOL)
    assert np.isclose(driver.e_dsrg2, -0.18563555265997586, rtol=RTOL, atol=ATOL)
