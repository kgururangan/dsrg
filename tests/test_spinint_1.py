...
if __name__ == "__main__":
    ...
    print("   MR-LDSRG(2) correlation energy should be: -0.124514914700")
    ...
    #
    assert np.isclose(driver.ref.e_cas, -99.9015526, rtol=RTOL)
    assert np.isclose(driver.e_dsrg2 + driver.ref.e_cas, -100.0260675, rtol=RTOL)
